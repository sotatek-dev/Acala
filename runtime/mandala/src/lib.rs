...
use pint_runtime_common::constants::{
	AssetUnbondingSlashingSpans, ExistentialDeposit, MinimumStatemintTransferAmount, RelayChainOrigin, CENTS,
};
use pint_xcm_calls::{
...
type PintGovernanceOrigin<AccountId, Runtime> = frame_support::traits::EnsureOneOf<
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// PINT
		AssetIndex: pint_asset_index::{Pallet, Call, Storage, Event<T>} = 211,
